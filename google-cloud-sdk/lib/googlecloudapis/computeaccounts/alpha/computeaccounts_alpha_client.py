"""Generated client library for computeaccounts version alpha."""
# NOTE: This file is autogenerated and should not be edited by hand.

from googlecloudapis.apitools.base.py import base_api
from googlecloudapis.computeaccounts.alpha import computeaccounts_alpha_messages as messages


class ComputeaccountsAlpha(base_api.BaseApiClient):
  """Generated client library for service computeaccounts version alpha."""
  ...
  _USER_AGENT = ''
  _CLIENT_CLASS_NAME = u'ComputeaccountsAlpha'
  ...
  def __init__(self, url='', credentials=None,
    ...
    url = url or u'https://www.googleapis.com/computeaccounts/alpha/'
    super(ComputeaccountsAlpha, self).__init__(
  ...
  class GlobalAccountsOperationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ComputeaccountsAlpha.GlobalAccountsOperationsService, self).__init__(client)
  ...
  class GroupsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ComputeaccountsAlpha.GroupsService, self).__init__(client)
      self._method_configs = {
  ...
  class LinuxService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ComputeaccountsAlpha.LinuxService, self).__init__(client)
      self._method_configs = {
  ...
  class UsersService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ComputeaccountsAlpha.UsersService, self).__init__(client)
      self._method_configs = {
