...
class ComputeaccountsGlobalAccountsOperationsDeleteRequest(_messages.Message):
...
class ComputeaccountsGlobalAccountsOperationsDeleteResponse(_messages.Message):
  """An empty ComputeaccountsGlobalAccountsOperationsDelete response."""


class ComputeaccountsGlobalAccountsOperationsGetRequest(_messages.Message):
...
class ComputeaccountsGlobalAccountsOperationsListRequest(_messages.Message):
...
class ComputeaccountsGroupsAddMemberRequest(_messages.Message):
...
class ComputeaccountsGroupsDeleteRequest(_messages.Message):
...
class ComputeaccountsGroupsGetRequest(_messages.Message):
...
class ComputeaccountsGroupsInsertRequest(_messages.Message):
...
class ComputeaccountsGroupsListRequest(_messages.Message):
...
class ComputeaccountsGroupsRemoveMemberRequest(_messages.Message):
...
class ComputeaccountsLinuxGetAuthorizedKeysViewRequest(_messages.Message):
...
class ComputeaccountsLinuxGetLinuxAccountViewsRequest(_messages.Message):
...
class ComputeaccountsUsersAddPublicKeyRequest(_messages.Message):
...
class ComputeaccountsUsersDeleteRequest(_messages.Message):
...
class ComputeaccountsUsersGetRequest(_messages.Message):
...
class ComputeaccountsUsersInsertRequest(_messages.Message):
...
class ComputeaccountsUsersListRequest(_messages.Message):
...
class ComputeaccountsUsersRemovePublicKeyRequest(_messages.Message):
...
class Group(_messages.Message):
  ...
  kind = _messages.StringField(4, default=u'computeaccounts#group')
...
class GroupList(_messages.Message):
  ...
  kind = _messages.StringField(3, default=u'computeaccounts#groupList')
...
class LinuxAccountViews(_messages.Message):
  ...
  kind = _messages.StringField(2, default=u'computeaccounts#linuxAccountViews')
...
class Operation(_messages.Message):
  ...
  kind = _messages.StringField(9, default=u'computeaccounts#operation')
...
class OperationList(_messages.Message):
  ...
  kind = _messages.StringField(3, default=u'computeaccounts#operationList')
  nextPageToken = _messages.StringField(4)
  selfLink = _messages.StringField(5)
...
class User(_messages.Message):
  ...
  kind = _messages.StringField(5, default=u'computeaccounts#user')
  name = _messages.StringField(6)
...
class UserList(_messages.Message):
  ...
  kind = _messages.StringField(3, default=u'computeaccounts#userList')
  nextPageToken = _messages.StringField(4)
  selfLink = _messages.StringField(5)
