...
class AndroidInstrumentationTest(_messages.Message):
  ...
  Fields:
    ...
    appPackageId: The java package for the application under test. Required
...
class ResultStorage(_messages.Message):
  ...
  Fields:
    ...
    toolResultsExecution: The tool results execution that results are written
      to. @OutputOnly
    toolResultsExecutionId: Deprecated.
    ...
    toolResultsHistoryId: Deprecated.
    toolResultsStepId: Deprecated.
  """
  ...
  toolResultsExecutionId = _messages.StringField(3)
  toolResultsHistory = _messages.MessageField('ToolResultsHistory', 4)
  toolResultsHistoryId = _messages.StringField(5)
  toolResultsStepId = _messages.StringField(6)
...
class TestDetails(_messages.Message):
  ...
  Fields:
    errorDetails: If the TestState is ERROR, then this string will contain
      human-readable details about the error. @OutputOnly
    errorMessage: If the TestState is ERROR, then this string will contain
      human-readable details about the error. @OutputOnly
    progressDetails: Human-readable, detailed description of the test's
      progress. For example: "Provisioning a device\n Starting Test"  During
      the course of execution data may be appended to the progress.
      @OutputOnly
  ...
  progressDetails = _messages.StringField(3)
  progressMessages = _messages.StringField(4, repeated=True)
