...
class SourceContext(_messages.Message):
  ...
  piper = _messages.MessageField('PiperDepotSourceContext', 5)
...
class SourceProjectsReposAliasesFilesGetRequest(_messages.Message):
  ...
  pageSize = _messages.IntegerField(15)
  pageToken = _messages.StringField(16)
  path = _messages.StringField(17, required=True)
  piper_branchName = _messages.StringField(18)
  piper_changeNumber = _messages.IntegerField(19)
  piper_disableComponents = _messages.BooleanField(20)
  piper_versionMap = _messages.BytesField(21)
  projectId = _messages.StringField(22, required=True)
  repoName = _messages.StringField(23, required=True)
  revisionId = _messages.StringField(24)
  startPosition = _messages.IntegerField(25)
...
class SourceProjectsReposRevisionsFilesGetRequest(_messages.Message):
  ...
  projectId = _messages.StringField(22, required=True)
  repoName = _messages.StringField(23, required=True)
  revisionId = _messages.StringField(24, required=True)
  startPosition = _messages.IntegerField(25)
  uid = _messages.StringField(26)
...
class SourceProjectsReposRevisionsListFilesRequest(_messages.Message):
  ...
  gerrit_hostUri = _messages.StringField(13)
  gerrit_revisionId = _messages.StringField(14)
  pageSize = _messages.IntegerField(15, variant=_messages.Variant.INT32)
  pageToken = _messages.StringField(16)
  piper_branchName = _messages.StringField(17)
  piper_changeNumber = _messages.IntegerField(18)
  piper_disableComponents = _messages.BooleanField(19)
  piper_versionMap = _messages.BytesField(20)
  projectId = _messages.StringField(21, required=True)
  repoName = _messages.StringField(22, required=True)
  revisionId = _messages.StringField(23, required=True)
...
class SourceProjectsReposWorkspacesFilesGetRequest(_messages.Message):
  ...
  name = _messages.StringField(14, required=True)
  pageSize = _messages.IntegerField(15)
  pageToken = _messages.StringField(16)
  path = _messages.StringField(17, required=True)
  piper_branchName = _messages.StringField(18)
  ...
  projectId = _messages.StringField(22, required=True)
  repoName = _messages.StringField(23, required=True)
  snapshotId = _messages.StringField(24)
  startPosition = _messages.IntegerField(25)
  uid = _messages.StringField(26)
...
class SourceProjectsReposWorkspacesSnapshotsFilesGetRequest(_messages.Message):
  ...
  projectId = _messages.StringField(22, required=True)
  repoName = _messages.StringField(23, required=True)
  snapshotId = _messages.StringField(24, required=True)
  startPosition = _messages.IntegerField(25)
  uid = _messages.StringField(26)
