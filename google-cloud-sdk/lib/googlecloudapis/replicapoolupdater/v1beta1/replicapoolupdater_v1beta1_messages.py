...
class ReplicapoolupdaterRollingUpdatesListRequest(_messages.Message):
  ...
  Fields:
    ...
    instanceGroupManager: The name of the instance group manager. Use this
      parameter to return only updates to instances that are part of a
...
class RollingUpdate(_messages.Message):
  ...
  policy = _messages.MessageField('PolicyValue', 10)
  progress = _messages.IntegerField(11, variant=_messages.Variant.INT32)
