...
class ExternalDataConfiguration(_messages.Message):
  ...
  Fields:
    ...
    sourceFormat: [Optional] The data format. External data sources must be in
      CSV format. The default value is CSV.
    sourceUris: [Required] The fully-qualified URIs that point to your data in
      ...
      and it must come after the 'bucket' name. CSV limits related to load
...
class GetQueryResultsResponse(_messages.Message):
  ...
  kind = _messages.StringField(5, default=u'bigquery#getQueryResultsResponse')
...
class JobConfigurationQuery(_messages.Message):
  ...
  writeDisposition = _messages.StringField(11)
...
class QueryResponse(_messages.Message):
  ...
  cacheHit = _messages.BooleanField(1)
  jobComplete = _messages.BooleanField(2)
  jobReference = _messages.MessageField('JobReference', 3)
  kind = _messages.StringField(4, default=u'bigquery#queryResponse')
  pageToken = _messages.StringField(5)
  rows = _messages.MessageField('TableRow', 6, repeated=True)
  schema = _messages.MessageField('TableSchema', 7)
  totalBytesProcessed = _messages.IntegerField(8)
  totalRows = _messages.IntegerField(9, variant=_messages.Variant.UINT64)
...
class Table(_messages.Message):
  ...
  friendlyName = _messages.StringField(5)
  id = _messages.StringField(6)
  kind = _messages.StringField(7, default=u'bigquery#table')
  lastModifiedTime = _messages.IntegerField(8, variant=_messages.Variant.UINT64)
  location = _messages.StringField(9)
  numBytes = _messages.IntegerField(10)
  numRows = _messages.IntegerField(11, variant=_messages.Variant.UINT64)
  schema = _messages.MessageField('TableSchema', 12)
  selfLink = _messages.StringField(13)
  tableReference = _messages.MessageField('TableReference', 14)
  type = _messages.StringField(15)
  view = _messages.MessageField('ViewDefinition', 16)
