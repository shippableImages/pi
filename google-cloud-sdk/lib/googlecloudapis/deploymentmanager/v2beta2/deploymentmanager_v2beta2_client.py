"""Generated client library for deploymentmanager version v2beta2."""
# NOTE: This file is autogenerated and should not be edited by hand.

from googlecloudapis.apitools.base.py import base_api
from googlecloudapis.deploymentmanager.v2beta2 import deploymentmanager_v2beta2_messages as messages


class DeploymentmanagerV2beta2(base_api.BaseApiClient):
  """Generated client library for service deploymentmanager version v2beta2."""
  ...
  _USER_AGENT = ''
  _CLIENT_CLASS_NAME = u'DeploymentmanagerV2beta2'
  ...
  def __init__(self, url='', credentials=None,
    ...
    url = url or u'https://www.googleapis.com/deploymentmanager/v2beta2/'
    super(DeploymentmanagerV2beta2, self).__init__(
  ...
  class DeploymentsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(DeploymentmanagerV2beta2.DeploymentsService, self).__init__(client)
      self._method_configs = {
          ...
          'Patch': base_api.ApiMethodInfo(
              ...
              ordered_params=[u'project', u'deployment'],
              path_params=[u'deployment', u'project'],
              query_params=[u'createPolicy', u'deletePolicy', u'updatePolicy'],
              relative_path=u'projects/{project}/global/deployments/{deployment}',
  ...
  class ManifestsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(DeploymentmanagerV2beta2.ManifestsService, self).__init__(client)
      self._method_configs = {
          'Get': base_api.ApiMethodInfo(
              http_method=u'GET',
  ...
  class OperationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(DeploymentmanagerV2beta2.OperationsService, self).__init__(client)
      self._method_configs = {
          'Get': base_api.ApiMethodInfo(
              http_method=u'GET',
  ...
  class ResourcesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(DeploymentmanagerV2beta2.ResourcesService, self).__init__(client)
      self._method_configs = {
          'Get': base_api.ApiMethodInfo(
              http_method=u'GET',
  ...
  class TypesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(DeploymentmanagerV2beta2.TypesService, self).__init__(client)
      self._method_configs = {
          'List': base_api.ApiMethodInfo(
              http_method=u'GET',
