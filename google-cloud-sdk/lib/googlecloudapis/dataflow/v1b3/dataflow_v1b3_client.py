...
from googlecloudapis.dataflow.v1b3 import dataflow_v1b3_messages as messages
...
class DataflowV1b3(base_api.BaseApiClient):
  ...
  class ProjectsJobsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      ...
      self._method_configs = {
          ...
          'Patch': base_api.ApiMethodInfo(
              http_method=u'PATCH',
              method_id=u'dataflow.projects.jobs.patch',
              ordered_params=[u'projectId', u'jobId'],
              path_params=[u'jobId', u'projectId'],
              query_params=[],
              relative_path=u'{projectId}/jobs/{jobId}',
              request_field=u'job',
              request_type_name=u'DataflowProjectsJobsPatchRequest',
              response_type_name=u'Job',
              supports_download=False,
          ),
    ...
    def Patch(self, request, global_params=None):
      ...
      Args:
        request: (DataflowProjectsJobsPatchRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Job) The response message.
      """
